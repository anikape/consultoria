...
const Password = () => {
  ...
  const handleConfirmPasswordChange = (e) => {
    ...
    setErrors((prevErrors) => ({ ...prevErrors, confirmPassword: !passwordMatch }));
  };
  ...
  const handleSubmit = (e) => {
    ...
    if (!errors.password && !errors.confirmPassword) {
      ...
      console.log('Form is valid. Password:', password, 'Confirm Password:', confirmPassword);
    } else {
      ...
      <div className={style.passContent}>
        <img className={style.logo} src={logo} alt="Logo" />
          ...
          <div className={style.info}>
            ...
            <p>A senha deverá conter exatamente 6 caracteres, dos quais
                4 deverão ser numéricos e 2 alfanuméricos.</p>
          </div>
        <form className={style.form} onSubmit={handleSubmit}>
          <div className={style.formContent}>
            <label className={style.label} htmlFor="password">Digite a senha:</label>
          ...
          <button className={style.button1} type="submit">Redefinir</button>
          <button className={style.button2} type="submit">Cancelar</button>
